...
namespace EventHistory
{
    ...
    //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
    {
        enum Type
        {
            ...
            successful = (Accepted|Answered|Initiated)
        };
    ...
    public:
        ...
        static const EventHistory::EventType::Type EventType = EventHistory::EventType::Call;
    ...
    public:
        ...
        static Pointer create(ali::string_const_ref accountId,
                              ali::generic_peer_address const& uri)
        //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        {
        ...
        //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        {
            setAttribute(Attributes::incomingVideo, incoming ? "1":"0");
            setAttribute(Attributes::outgoingVideo, outgoing ? "1":"0");
        }
        ...
        //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        {
            setAttribute(Attributes::autoCallRecording, autoCallRecord ? "1":"0");
        }
    ...
    public:
        ...
        //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        {
            static const ali::string_literal callResult;
            static const ali::string_literal callDuration;
            static const ali::string_literal recording;
            static const ali::string_literal recordingProtected;
            static const ali::string_literal incomingVideo;
            static const ali::string_literal outgoingVideo;
            static const ali::string_literal transferredTo;
            static const ali::string_literal forwardedTo;
            static const ali::string_literal sipisTimestamp;
            static const ali::string_literal autoCallRecording;
            static const ali::string_literal dialAction;
            static const ali::string_literal smart;
            static const ali::string_literal pushCallId;
        };
    };
