...
namespace CountryCode
{
    ...
    public:
        ...
        /**
         * Returns the country code prefix as it was recognized in country resolution process. The
         * reuturned value is a country code, possibly followed by more digits which define some 
         ...
         *         empty string.
         */
        ali::string const& getCountryCode() const
        {
            return mInfo.countryCode;
        }
