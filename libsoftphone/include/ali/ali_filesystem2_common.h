...
public:
    ...
    ali::tstring& format_platform_string(
        ali::tstring& platform_string ) const
    {
        platform_string.append(this->_value);
...
private:    //  Methods
    explicit path_root( ali::tstring const& value )
    :   _value(value)
    {}
...
// ******************************************************************
{
    ...
    path_segment( ali::tstring_const_ref value )
    :   value(value)
    {}

    path_segment& operator=( ali::tstring_const_ref b )
    {
        value = b;
        return *this;
    }
    ...
    {
        return value == tstring_literal(_T("."));
    }
...
public:     //  Methods
    ...
    ali::tstring& format_platform_string_without_last_segment(
        ali::tstring& platform_string ) const
    {
    ...
    path& operator /=( ali::tstring_const_ref s )
    {
...
inline path operator /( path p, ali::tstring_const_ref s )
{
    p /= s;
    return p;
}
...
// ******************************************************************
inline bool set_last_modified(
    c_tstring_const_ref path,
    time::unix_timestamp time )
// ******************************************************************
{
    time::unix_micro_timestamp micro_time;
    return set_last_modified(path, convert(micro_time, time));
}
...
// ******************************************************************
inline ali::array<entry> try_get_entries(
    c_tstring_const_ref path,
    get_entries_result* result )
// ******************************************************************
{
    return folder::try_get_entries(
        path, callback<bool(entry const&)>(), result);
}
...
// ******************************************************************
inline ali::array<entry> get_entries(
    c_tstring_const_ref path )
// ******************************************************************
{
    return folder::get_entries(path, nullptr);
}
...
// ******************************************************************
inline int try_remove_entries(
    c_tstring_const_ref folder )
// ******************************************************************
{
    return folder::try_remove_entries(folder, nullptr);
}
...
template <>
struct format_t<filesystem2::path>
{
public:
    format_t()
    {}

    tstring operator ()(filesystem2::path const& value) const
    {
        return value.format_platform_string();
    }
};
