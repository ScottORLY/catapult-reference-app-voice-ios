...
/// \remark As can be seen from the invariant, the `set` class
...
///
// ******************************************************************
template <typename T, typename is_less_type>
class set : private is_less_type
// ******************************************************************
{
public:
...
public:
    ...
    set( void ) {}
        ...
        ///             elements.
        ///
        /// \post   <tt>this->is_less() == is_less && this->is_empty()</tt>
        ///
        /// \throws noexcept <tt>(noexcept(is_less_type(is_less_type)))</tt>
        ///
    explicit set( is_less_type const& is_less )
    :   is_less_type(is_less)
    {}
    ...
    explicit set( T const& value )
    {
        ...
        ///             Element to insert into this set.
        ///
        /// \post   <tt>this->is_less() == is_less && post this->insert(value)</tt>
        ///
        /// \throws noexcept <tt>(false)</tt>
        ///
    set( is_less_type const& is_less, T const& value )
    :   is_less_type(is_less)
    {
        this->insert(value);
    }
        ...
        /// \throws noexcept <tt>(false)</tt>
        ///
    explicit set( array_const_ref<T> b )
    {
        this->insert(b);
    }

    set( ali::initializer_list<T> b )
    {
        ...
        ///             Array of elements to populate this set with.
        ///
        /// \post   <tt>this->is_less() == is_less && post this->insert(b)</tt>
        ///
        /// \throws noexcept <tt>(false)</tt>
        ///
    set( is_less_type const& is_less, array_const_ref<T> b )
    :   is_less_type(is_less)
    {
        this->insert(b);
    }
    ...
    set( set const& b )
    :   is_less_type(b.is_less()),
        _arr(b._arr)
    {}

    set( set&& b )
    :   is_less_type(ali::move(b.is_less())),
        _arr(ali::move(b._arr))
    {}

    set& operator=( set const& b )
    {
        this->is_less() = b.is_less();
        this->_arr = b._arr;
        return *this;
    }
    ...
    set& operator=( set&& b )
    {
        this->is_less() = ali::move(b.is_less());
...
ALI_DEPRECATED(
    ...
    {
        int const idx = this->lower_bound(value);
    ...
    {
        return this->lower_bound(value);
    }

ALI_DEPRECATED(
    template <typename U>
    int find_index( U const& value ) const
    {
        return this->index_of(value);
    }
);
    ...
    friend const_iterator begin(set const& s)
    {
        return s.begin();
    }
    ...
    friend const_iterator end(set const& s)
    {
        return s.end();
    }
    ...
    {
        int const idx = this->lower_bound(t);
...
ALI_DEPRECATED(
    ...
    void swap( set& b )
    {
        ...
        swap(this->is_less(), b.is_less());
    }

        /// \brief See \ref set::swap.
        ///
    ...
    ali::array<T> const& as_array( void ) const
    {
        ...
        /// \throws noexcept
        ///
    is_less_type const& is_less( void ) const
    {
        return *this;
    }
    ...
    {
        return is_less_type::operator()(t1, t2);
    }
    ...
    {
        return !this->is_less(t1, t2) && !this->is_less(t2, t1);
    }

private:    //  Methods
    is_less_type& is_less( void )
    {
        return *this;
    }

    template <typename TT>
    int lower_bound( TT const& t ) const
    {
        int count = this->_arr.size();
        int first = 0;
        ...
        while (count > 0)
        {
            ...
            if ( this->is_less(this->_arr[mid], t) )
...
template <typename T, typename is_less_type>
struct format_t<ali::set<T, is_less_type> >
    : public format_t<ali::array<T>>
{
public:
    format_t(format_t<ali::array<T>> const& values = format_t<ali::array<T>>())
        : format_t<ali::array<T>>(values)
    {}

    typedef typename format_t<ali::array<T>>::helper helper;

    helper operator ()(const ali::set<T, is_less_type> &set) const
    {
        return helper(set.as_array(), *this);
    }
};
