...
namespace ali
{
    namespace json
    {
        ...
        // ******************************************************************
        class dict
            : public assoc_array<string, object>
        // ******************************************************************
        {
        public:
            using super = assoc_array<string, object>;
        ...
        public:
            // ******************************************************************
            object( nullptr_type const& = nullptr )
            // ******************************************************************
                :_type(Null)
            {}
            ...
            // ******************************************************************
            friend bool operator ==( nullptr_type const&,
                                     object const& second )
            // ******************************************************************
            {
            ...
            // ******************************************************************
            {
                return is_string() && as_string() == string_const_ref(other);
            }
            ...
            // ******************************************************************
            friend bool operator ==( char const* first,
                                     object const& second )
            // ******************************************************************
            {
                return second == first;
            ...
            // ******************************************************************
            friend bool operator ==( char * first,
                                     object const& second )
            // ******************************************************************
            {
                return second == first;
            ...
            // ******************************************************************
            object& operator =( nullptr_type const& )
            // ******************************************************************
            {
                set_null();
                return *this;
            ...
            // ******************************************************************
            object& operator =( char const *str )
            // ******************************************************************
            {
                as_string() = string_const_ref(str);
                return *this;
            }
        ...
        private:
            ...
            union
            {
                ...
                char                    _array[sizeof(array)];
                char                    _dict[sizeof(dict)];
                bool                    _bool;
                ali::int64              _int;
                double                  _float;
            };
        ...
        public:
            ...
            to_string( object const& doc, ali::string_const_ref indent="" );
            to_string( array const& doc, ali::string_const_ref indent="" );
            to_string( dict const& doc, ali::string_const_ref indent="" );
        ...
        // ******************************************************************
                :to_string(doc,ali::string().append(indent,' '))
            {}

            // ******************************************************************
            to_pretty_string( array const& arr, int indent = 3 )
            // ******************************************************************
                :to_string(arr,ali::string().append(indent,' '))
            {}

            // ******************************************************************
            to_pretty_string( dict const& d, int indent = 3 )
            // ******************************************************************
                :to_string(d,ali::string().append(indent,' '))
            {}
        };
